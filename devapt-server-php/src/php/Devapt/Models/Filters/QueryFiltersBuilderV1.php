<?php
/**
 * @file        QueryFiltersBuilderV1.php
...
use Devapt\Models\QueryUnopOperatorBuilder;
use Devapt\Models\QueryOperatorBuilder;
...
final class QueryFiltersBuilderV1
{
	// STATIC ATTRIBUTES
	...
	*/
	...
	{
		$context = 'QueryFiltersBuilderV1.buildFilterNode';
		...
		if ($field_has_foreign_link)
		{
			...
			$sub_select_exp = \Devapt\Models\SqlSqlSubQuery::compileSubSelect($arg_sql, $field_record);
		...
		if ( is_string($filter_modifier) && $filter_modifier !== '' )
		{
			...
			// GET FILTER MODIFIER
			$left_expr = QueryUnopOperatorBuilder::buildOperatorExpression($filter_type, $filter_modifier, $left_str);
