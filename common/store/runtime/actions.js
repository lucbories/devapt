...
export const dispatch_store_runtime_set_all = (arg_config) => dispatch( create_store_runtime_set_all(arg_config) )
export const dispatch_store_config_get_value = (arg_path) => dispatch( create_store_runtime_get_value(arg_path) )
export const dispatch_store_runtime_update_value = (arg_path, arg_value) => dispatch( create_store_runtime_update_value(arg_path, arg_value) )
export const dispatch_store_runtime_create_value = (arg_path, arg_value) => dispatch( create_store_runtime_create_value(arg_path, arg_value) )
export const dispatch_store_runtime_remove_value = (arg_path) => dispatch( create_store_runtime_remove_value(arg_path) )
