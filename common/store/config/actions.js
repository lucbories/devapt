...
export const dispatch_store_config_get_value = (arg_path) => dispatch( create_store_config_get_value(arg_path) )
export const dispatch_store_config_update_value = (arg_path, arg_value) => dispatch( create_store_config_update_value(arg_path, arg_value) )
export const dispatch_store_config_create_value = (arg_path, arg_value) => dispatch( create_store_config_create_value(arg_path, arg_value) )
export const dispatch_store_config_remove_value = (arg_path) => dispatch( create_store_config_remove_value(arg_path) )
