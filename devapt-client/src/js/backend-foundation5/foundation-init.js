...
define(['modernizr', 'Devapt', 'core/application', 'foundation.alert', 'foundation.dropdown', 'foundation.tooltip', 'foundation.topbar'],
function(m, Devapt, DevaptApplication, undefined)
{
	...
	Devapt.use_css(url_base + '../../devapt-client/lib/foundation-5.0.2/css/foundation.min.css');
