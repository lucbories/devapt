...
const context = 'server/rendering/base/component'
...
export default class Component extends ComponentBase
{
	...
	init_state(arg_state)
	{
		...
		arg_state.is_rendered = this.dom_is_rendered_on_node
	...
	render()
	{
		this.dom_is_rendered_on_node = true
		this.state.is_rendered = this.dom_is_rendered_on_node
