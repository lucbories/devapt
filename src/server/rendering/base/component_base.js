...
const context = 'server/rendering/base/component_base'



/**
 * Base class for Component class to deal with settings.
 *  A rendering component is defined by its settings at creation.
 *  A rendering component is a stateless object which has a render() method.
